...
<div class="card">
    <h2 style="font-size:1.2rem;">1. Neutralidade Informacional</h2>
...
<div class="card">
    <h2 style="font-size:1.2rem;">2. Separação de Camadas</h2>
    <p style="text-transform:uppercase; font-size:0.9rem;">Para evitar confusões e desinformação, distinguimos rigorosamente:</p>
...
<div class="card">
    <h2 style="font-size:1.2rem;">3. Auditabilidade e Não Invenção de Dados</h2>
    <p style="text-transform:uppercase; font-size:0.9rem;">
...
<div class="card">
    <h2 style="font-size:1.2rem;">4. Privacidade por Padrão (LGPD)</h2>
    <p style="text-transform:uppercase; font-size:0.9rem;">
